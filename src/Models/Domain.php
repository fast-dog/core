...
class Domain extends Model implements TableModelInterface, PropertiesInterface
{
    ...
    public function getTableCols(): array
    {
        return [
            [
                'name' => trans('config::forms.domain.general.fields.name'),
                'key' => Domain::NAME,
                'domain' => true,
                'callback' => false,
                'link' => 'domain_item',
            ...
            [
                'name' => trans('config::forms.domain.general.fields.url'),
                'key' => Domain::URL,
                'link' => null,
                'domain' => false,
            ],
            [
                'name' => trans('config::forms.domain.general.fields.code') ,
                'key' => Domain::CODE,
                'domain' => false,
                'link' => null,
                'width' => 100,
        ...
        $default = [
            [
                [
                    ...
                    BaseFilter::PLACEHOLDER => trans('config::forms.domain.general.fields.name'),
